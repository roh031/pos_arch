...
pacman -S tar gzip bzip2 unzip unrar p7zip --noconfirm

# Suporte a ntfs e servidor SSH
pacman -S ntfs-3g  --noconfirm 

# Suporte ao GIT 
pacman -S git wget curl openssh --noconfirm
...
pacman -S  dcfldd testdisk foremost smbclient samba neofetch clamav  scrot ddrescue dvd+rw-tools htop gparted uget transmission-qt gftp firefox firefox-i18n-pt-br  chromium  evince brasero libreoffice gthumb audacious vlc papirus-icon-theme audacity  systemd-swap emelfm2 simplescreenrecorder --noconfirm 
